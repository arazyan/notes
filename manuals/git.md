...
### Использование своего репозитория на другом компьютере
> 
> 1. Сгенерировать ssh ключ и добавить его в свой гитхаб
> 2. Клонировать нужные репозитории с помощью ssh